...
export default {
  ...
  formulario: {
    ...
    campos: {
      ...
      pais: { rotulo: 'País', opcoes: [['br', 'Brasil'], ['ch', 'Suíça'], ['de', 'Alemanha'], ['at', 'Áustria'], ['pt', 'Portugal'], ['es', 'Espanha'], ['us', 'Estados Unidos']] },
    ...
    indicacao: {
      ...
      exemplo: 'ex.: joaosilva',
      selo: (nome) => `Indicado por ${nome}`,
      remover: 'não fui indicado',
    },
    ...
    erros: {
      ...
      jaExiste: 'Este e-mail já tem conta. Entre com a senha que você criou — ou peça uma nova.',
